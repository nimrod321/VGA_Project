...
convert_to_mif(os.path.join(base, 'riddler_sprite_1781009334946.png'), os.path.join('MIF', 'riddler.mif'), 16, 16)
convert_to_mif(os.path.join(base, 'maryjane_sprite_1781009386144.png'), os.path.join('MIF', 'maryjane.mif'), 16, 16)
